...
namespace Telegram.Bot.States
{
    ...
    {
        // public static bool IsGroup(this Update update) => update.GetChat()?.Type == ChatType.Group
        //    || update.GetChat()?.Type == ChatType.Supergroup;
        // public static bool IsChanel(this Update update) => update.GetChat()?.Type == ChatType.Channel;
